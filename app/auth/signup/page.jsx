        ...
        <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div className="text-center">
              ...
              <h2 className="mt-12 text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">
                Create your account
              </h2>
              <p className="mt-2 text-sm leading-6 text-gray-500 dark:text-gray-300">
                Join Ohi! and start selling today
              </p>
            </div>
            ...
            <div className="mt-6">
              <Card className="w-full border-none bg-zinc-100 dark:bg-zinc-800">
                <CardHeader className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Create an account to list products and manage your store</p>
                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-center text-muted-foreground">
                      ...
                      <Link href="/policies/terms" className="underline hover:text-foreground">
                        Terms of Service
                      </Link>{' '}
                      and{' '}
                      <Link href="/policies/privacy" className="underline hover:text-foreground">
                        Privacy Policy
                      </Link>
                    </p>
                  </div>
